...
HD_PWD='/home1/shivang/github/HMB_CalRDout/HMB_Cal/HMB_Cal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log target_C_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source target_C_top.tcl -notrace
