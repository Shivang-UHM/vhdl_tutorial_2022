...
HD_PWD='/home1/shivang/github/HMB_CalRDout/HMB_Cal/HMB_Cal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log target_C_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source target_C_top.tcl
