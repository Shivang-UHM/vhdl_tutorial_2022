...
# Path of this script: /home1/shivang/github/HMB_CalRDout/hmb_cpp_source/hmb_cpp_sw_system/_ide/scripts/debugger_hmb_cpp_sw-default.tcl
# 
# 
# Usage with xsct:
# In an external shell use the below command and launch symbol server.
# symbol_server -S -s tcp::1541
# To debug using xsct, launch xsct and run below command
# source /home1/shivang/github/HMB_CalRDout/hmb_cpp_source/hmb_cpp_sw_system/_ide/scripts/debugger_hmb_cpp_sw-default.tcl
# 
connect -path [list tcp::1541 tcp:192.168.153.115:3121]
