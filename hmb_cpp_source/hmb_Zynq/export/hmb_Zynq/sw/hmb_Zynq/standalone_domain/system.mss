...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI4lite_to_GPIO
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI4lite_to_GPIO_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = my_axi4_lite_exporter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = my_axi4_lite_exporter_0
END
